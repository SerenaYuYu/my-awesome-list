...
**Original Author(s)**: @rust-unofficial  
**Original Repository**: [https://github.com/rust-unofficial/awesome-rust](https://github.com/rust-unofficial/awesome-rust)  
...
- **To the original project**: Please submit PRs to [the original repository](https://github.com/rust-unofficial/awesome-rust)
...
```bash
# In this repository
git remote add upstream https://github.com/rust-unofficial/awesome-rust
git fetch upstream
